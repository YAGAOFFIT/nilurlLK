          ...
          <div id="header-container" className="container">
            <div id="profile-container" className="profile-container">
              <div id="logo-container">
                ...
                <img id="circle-for-user-letter" src={`${process.env.PUBLIC_URL}/images/circle.png`} className="frame-svg3" />
              ...
              <div id="logo-with-dot-container">
                <span className="initial-letter">A</span>
                <img id="circle-for-user-letter-with-dot" src={`${process.env.PUBLIC_URL}/images/circle-with-dot.png`} className="frame-svg3" />
              </div>
            </div>
          </div>
        </div>
